                    ...
                    <div class="card container-fluid" style="width: 15rem;background-color:#DEF7E5;">
                        ...
                        <a style="text-decoration:none;color:black;" href="/dashboard">
                            ...
                            <form action="/logout" method="POST">
                                <div class="col">
                                    <div class="row">
                                        <img src="https://cdn.discordapp.com/attachments/811787365630738502/965256455278178394/unknown.png" alt="" srcset="" style="width: 100px;height:75px;" class="mx-auto mt-3">
                                    </div>
                                    <div class="row">
