...
<body style="background-color:#DEF7E5;">
    ...
    <div class="card" style="margin-top: 30px;">
        <div class="card-body text-center fw-bold" style="background-color:#FF97BD;">
            Data Tidak Boleh Kosong
        </div>
    </div>
    <div class="card container-fluid text-center mx-auto" style="margin-top: 25px;">
        <div class="card-body">
        <div class="row">
                <h1 class="col mx-0"style="color:#06DA3E;">KRIPSKUY</h1>
            </div>
            </div>
                <form>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="inputAlamat3" class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-8">
                        <input type="password" class="form-control" id="inputPassword3" placeholder= "Masukkan Alamat">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputTelp3" class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="row mb-3">
                        <label for="inputConfPassword3" class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-8">
                        <input type="password" class="form-control" id="inputPassword3" placeholder= "Konfirmasi Password">
                        </div>
                    </div>
                    <button type="button" class="btn btn-warning mx-auto col-sm-4 mb-5 mt-3">Daftar</button>
                </form>
            </div>
        </div>
    </div>
