...
<body style="background-color:#DEF7E5;">
    <div class="container my-5 col-xl-4">
        <div class="card container-fluid text-center mx-auto" style="margin-top: 80px;">
            <div class="card-body">
                <div class="row">
                    <img src="img/box product.png" alt="" srcset="" style="width: 100px;height:75px;" class="mx-auto mt-5 mb-3">
                </div>
            </div>
            <form action="/formtambahproduk" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control @error('jumlah_sisa_produk') is-invalid @enderror" id="jumlah_sisa_produk" name = "jumlah_sisa_produk" placeholder= "Masukkan jumlah sisa produk">
