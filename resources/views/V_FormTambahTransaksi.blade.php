        ...
        <div class="card container-fluid text-center mx-auto" style="margin-top: 120px;">
            ...
            <form action="/V_FormTambahTransaksi" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control @error('pemasukan') is-invalid @enderror" id="pemasukan" name = "pemasukan" placeholder="Masukkan pemasukan">
                        @error('pemasukan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control @error('pengeluaran') is-invalid @enderror" id="pengeluaran" name = "pengeluaran" placeholder="Masukkan pengeluaran">
                        @error('pengeluaran')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
